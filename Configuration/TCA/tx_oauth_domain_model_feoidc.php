    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_oauth_domain_model_feoidc',
                'foreign_table_where' => 'AND tx_oauth_domain_model_feoidc.pid=###CURRENT_PID### AND tx_oauth_domain_model_feoidc.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
